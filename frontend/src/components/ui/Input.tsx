...
const sizeStyles: Record<InputSize, { height: string; fontSize: string; padding: string; iconSize: number }> = {
  sm: {
    height: '36px',
...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const inputStyles: React.CSSProperties = {
      ...
      paddingLeft: leftIcon ? `calc(${sizeStyle.padding.split(' ')[1]} + ${sizeStyle.iconSize + 12}px)` : undefined,
      paddingRight: rightIcon ? `calc(${sizeStyle.padding.split(' ')[1]} + ${sizeStyle.iconSize + 12}px)` : undefined,
    ...
    const floatingLabelStyles: React.CSSProperties = {
      ...
      pointerEvents: 'none',
      backgroundColor: variant === 'default' ? colors.dark.surface : 'transparent',
