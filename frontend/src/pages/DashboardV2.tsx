...
// Design System
import { colors, spacing, radius, shadows, media, breakpoints } from '../design/tokens';
          ...
          >
            {[
              ...
              <div key={i}>
                ...
                <div style={{ ...textStyles.caption, color: colors.text.tertiary }}>
                  {stat.label}
                </div>
              </div>
            ))}
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
        ...
        {metric.trend !== undefined && (
          <Badge
            ...
            size="xs"
            icon={<ArrowUpRight size={10} style={{ transform: metric.trend < 0 ? 'rotate(180deg)' : 'none' }} />}
          >
...
// Quick Action Card
const QuickActionCard: React.FC<{ action: QuickAction; onClick: () => void }> = ({ action, onClick }) => (
  <motion.div
    variants={staggerItem}
  ...
  >
    <Card variant="surface" size="md" hover glow glowColor={action.color} animated={false}>
...
const Dashboard: React.FC = () => {
  ...
  const tabItems: TabItem[] = useMemo(() => [
    ...
    { id: 'cad', icon: <Layers size={22} />, label: 'CAD', path: '/cad-dashboard' },
    { id: 'chat', icon: <MessageSquare size={22} />, label: 'Chat', path: '/chatcad' },
    { id: 'profile', icon: <User size={22} />, label: 'Perfil', path: '/profile' },
  ], []);
      ...
      >
        ...
        >
          ...
          <Button variant="ghost" size="sm" leftIcon={<Bell size={18} />}>
            <Badge variant="danger" dot style={{ position: 'absolute', top: 8, right: 8 }} />
          </Button>
          <Button variant="ghost" size="sm" leftIcon={<Settings size={18} />} onClick={() => navigate('/settings')} />
        </motion.header>
        ...
        <HeroSection
          userName="Operador"
          isDemo={isDemo}
          onNewProject={() => navigate('/global-setup')}
        ...
        {/* KPI Metrics */}
        <motion.section variants={staggerItem} style={{ marginBottom: spacing[8] }}>
        ...
        {projects.length > 0 && (
          <motion.section variants={staggerItem}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: spacing[4] }}>
              ...
              <Button variant="ghost" size="sm" rightIcon={<ChevronRight size={16} />} onClick={() => navigate('/quality-gate')}>
                Ver todos
              </Button>
            </div>
            <motion.div
                ...
                <motion.div key={project.project_id} variants={staggerItem}>
                  <Card variant="surface" size="md" hover animated={false}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: spacing[3] }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ ...textStyles.label.md, color: colors.text.primary }}>
                      ...
                      <Badge variant={project.status === 'completed' ? 'success' : 'default'} size="xs">
