        ...
        >
          <div style={{ color: "#94a3b8", fontSize: "15px", lineHeight: 1.8 }}>
            ...
            <section style={{ marginBottom: "32px" }}>
              <p>
                A Engenharia CAD ("nós", "nosso") está comprometida em proteger
                sua privacidade. Esta Política de Privacidade explica como
                coletamos, usamos e protegemos suas informações pessoais quando
            ...
            <section style={{ marginBottom: "32px" }}>
              ...
              <ul style={{ paddingLeft: "24px", marginTop: "12px" }}>
                <li>
                  <strong style={{ color: "#fff" }}>Stripe:</strong>{" "}
                  Processamento de pagamentos
                </li>
                <li>
                  <strong style={{ color: "#fff" }}>OpenAI/Anthropic:</strong>{" "}
                  Processamento de IA (prompts anonimizados)
                </li>
                <li>
                  <strong style={{ color: "#fff" }}>Vercel/Neon:</strong>{" "}
                  Hospedagem e banco de dados
                </li>
                <li>
                  <strong style={{ color: "#fff" }}>Autoridades:</strong> Quando
                  exigido por lei
                </li>
              </ul>
              <p style={{ marginTop: "12px" }}>
                <strong style={{ color: "#fff" }}>Não vendemos</strong> seus
            ...
            <section style={{ marginBottom: "32px" }}>
              ...
              <ul style={{ paddingLeft: "24px", marginTop: "12px" }}>
                <li>
                  <strong style={{ color: "#fff" }}>Acesso:</strong> Solicitar
                  cópia dos seus dados pessoais
                </li>
                <li>
                  <strong style={{ color: "#fff" }}>Correção:</strong> Corrigir
                  dados incompletos ou incorretos
                </li>
                <li>
                  <strong style={{ color: "#fff" }}>Exclusão:</strong> Solicitar
                  exclusão dos seus dados
                </li>
                <li>
                  <strong style={{ color: "#fff" }}>Portabilidade:</strong>{" "}
                  Receber seus dados em formato estruturado
                </li>
                <li>
                  <strong style={{ color: "#fff" }}>Revogação:</strong> Retirar
                  consentimento a qualquer momento
                </li>
                <li>
                  <strong style={{ color: "#fff" }}>Informação:</strong> Saber
                  com quem seus dados são compartilhados
                </li>
              </ul>
              <p style={{ marginTop: "12px" }}>
                Para exercer seus direitos, acesse as configurações da conta ou
                entre em contato com nosso DPO em{" "}
                <a
                  href="mailto:dpo@engenharia-cad.com"
                  style={{ color: "#00A1FF" }}
                >
                  dpo@engenharia-cad.com
                </a>
                .
              </p>
            </section>
            ...
            <section style={{ marginBottom: "32px" }}>
              ...
              <ul style={{ paddingLeft: "24px", marginTop: "12px" }}>
                <li>
                  <strong style={{ color: "#fff" }}>Essenciais:</strong> Manter
                  sua sessão ativa e preferências
                </li>
                <li>
                  <strong style={{ color: "#fff" }}>Analytics:</strong> Entender
                  como você usa o Serviço
                </li>
                <li>
                  <strong style={{ color: "#fff" }}>Funcionais:</strong> Lembrar
                  configurações e preferências
                </li>
              </ul>
              <p style={{ marginTop: "12px" }}>
                Você pode gerenciar cookies nas configurações do seu navegador.
                Desabilitar cookies essenciais pode afetar o funcionamento do
                Serviço.
              </p>
            </section>
            ...
            <section style={{ marginBottom: "32px" }}>
              ...
              <p>
                ...
                localizados fora do Brasil (Estados Unidos). Garantimos que
                essas transferências estão protegidas por medidas de segurança
                adequadas, incluindo cláusulas contratuais padrão aprovadas pela
                ANPD.
              </p>
            </section>
            ...
            <section style={{ marginBottom: "32px" }}>
              ...
              <p>
                ...
                intencionalmente dados de menores. Se você acredita que um menor
                forneceu dados pessoais, entre em contato conosco imediatamente.
              </p>
            </section>
            ...
            <section style={{ marginBottom: "32px" }}>
              ...
              <p>
                ...
                sobre alterações significativas por email ou através do Serviço.
                A data da última atualização sempre estará indicada no topo
                desta página.
              </p>
            </section>
