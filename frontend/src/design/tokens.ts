...
export const colors = {
  ...
  gradient: {
    ...
    radialGlow: 'radial-gradient(circle at 50% 0%, rgba(0,161,255,0.15) 0%, transparent 50%)',
    mesh: `
...
export const shadows = {
  ...
  // Glow effects
  glowPrimary: '0 0 20px rgba(0, 161, 255, 0.3), 0 0 40px rgba(0, 161, 255, 0.1)',
  glowSecondary: '0 0 20px rgba(99, 102, 241, 0.3), 0 0 40px rgba(99, 102, 241, 0.1)',
  ...
  // Modal shadow
  modal: '0 0 0 1px rgba(255, 255, 255, 0.1), 0 25px 50px -12px rgba(0, 0, 0, 0.7)',
