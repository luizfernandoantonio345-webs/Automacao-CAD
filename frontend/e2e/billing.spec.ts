...
test.describe('Billing Page', () => {
  ...
  test('should navigate between tabs', async ({ page }) => {
    ...
    await expect(page.locator('text=/starter|professional|enterprise/i')).toBeVisible();
  });
});
...
test.describe('Pricing Page', () => {
  ...
  test('should navigate to checkout on plan selection', async ({ page }) => {
    ...
    const ctaButton = page.getByRole('button', { name: /começar|assinar|upgrade/i }).first();
